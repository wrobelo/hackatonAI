...
async def scene_description(context_json: str) -> Dict[str, str]:
    ...
    agent = Agent(
        ...
        instructions=(
            ...
            "TASK: Write one richly detailed scene description that a DALL·E model can consume directly for generating picture.  "
            "Rules: \n"
            " - Do not create a description more than 950 characters, not more than max length, including brand hero .\n"
            "Include:\n"
            ...
            "  – Tone & style: match the company’s tone of voice and color palette.\n"
            "  – Brand hero: include the brand hero in the scene, but do not change the text of the brand hero.\n"
            "  – Picture style: should be cartoonish, bright, and colorful.\n"
